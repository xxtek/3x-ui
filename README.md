...
[![](https://img.shields.io/github/v/release/xxtek/3x-ui.svg)](https://github.com/xxtek/3x-ui/releases)
[![](https://img.shields.io/github/actions/workflow/status/xxtek/3x-ui/release.yml.svg)](#)
[![GO Version](https://img.shields.io/github/go-mod/go-version/xxtek/3x-ui.svg)](#)
[![Downloads](https://img.shields.io/github/downloads/xxtek/3x-ui/total.svg)](#)
...
```
bash <(curl -Ls https://raw.githubusercontent.com/xxtek/3x-ui/master/install.sh)
```
...
```
bash <(curl -Ls https://raw.githubusercontent.com/xxtek/3x-ui/master/install.sh) v1.4.0
```
...
[![Stargazers over time](https://starchart.cc/xxtek/3x-ui.svg)](https://starchart.cc/xxtek/3x-ui)
